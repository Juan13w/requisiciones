...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-09-2025 a las 15:56:03
...
--
ALTER TABLE `coordinador`
  MODIFY `coordinador_id` int(100) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `requisicion`
--
ALTER TABLE `requisicion`
  MODIFY `requisicion_id` int(100) NOT NULL AUTO_INCREMENT;
COMMIT;
